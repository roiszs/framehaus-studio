  ...
  return (
    <div className="relative h-64 overflow-hidden rounded-[1.75rem] border border-[#F5F1EA]/10 bg-[#181410]">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(180deg,rgba(13,13,13,0.12),rgba(13,13,13,0.86)), url('${image}')`,
        }}
      />
            ...
            <Reveal>
              <div className="relative min-h-[480px] overflow-hidden rounded-[2rem] border border-[#F5F1EA]/10 bg-[#181410]">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(180deg,rgba(13,13,13,0.1),rgba(13,13,13,0.88)), url('/framehaus/content-day.svg')",
                  }}
                />
